...
| Agent harness | `.Codex/`, `.codex/`, `AGENTS.md` |
...
Then add one line to `AGENTS.md` and `AGENTS.md`: `Read CONSTRAINTS.md before writing code. Do not weaken it to make a change pass.`
...
- [ ] `AGENTS.md` or `AGENTS.md` points at the file
