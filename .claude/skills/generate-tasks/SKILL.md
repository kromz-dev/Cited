---
name: generate-tasks
description: Turn a PRD into a step-by-step Markdown task list (parent tasks and sub-tasks, relevant files) for implementation. Use after a PRD exists and the user wants dev tasks.
---
