---
name: create-prd
description: Generate a junior-developer-ready Product Requirements Document (PRD) in Markdown from a feature idea: clarifying questions, goals, user stories, functional requirements, non-goals, success metrics. Use when the user asks for a PRD.
---
