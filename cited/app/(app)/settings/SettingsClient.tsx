...
/**
 * Coquille interactive des paramètres : navigation par ancre et sections qui
 * restent hors périmètre de T040 (Alertes, Équipe, Accès API, Marque
 * blanche). La section Abonnement est un Server Component rendu par le
