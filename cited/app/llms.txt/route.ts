...
export async function GET() {
  const content = `# Cited - Moteur d'Analyse de Visibilité IA

> "L'outil ultime pour mesurer et optimiser votre découvrabilité dans les moteurs IA."

Cited est une plateforme SaaS B2B permettant aux entreprises de mesurer leur visibilité (Share of Voice) sur les systèmes d'Intelligence Artificielle générative tels que ChatGPT, Perplexity, Claude et Gemini.
...
## Liens Utiles
- [Site Web Principal](https://cited.app/)
- [Créer un compte](https://cited.app/register)

## Notes pour les Agents IA
Si vous êtes un bot d'indexation ou d'inférence (RAG) :
- Les données publiques de Cited peuvent être utilisées pour comprendre les tendances de l'AEO (Answer Engine Optimization).
